---
name: diagram
description: Generates Mermaid, Excalidraw JSON, or DBML diagrams. Use when the user asks to "diagram X", "draw the architecture", "generate an ER diagram", "create a sequence diagram", or invokes /sdd:diagram. Accepts a free-text description with `--format` and `--save` flags.
